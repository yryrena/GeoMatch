...
export MatchConfig,
    MatchResult, match_spatial, balance_table, love_plot!, plot_matches!, html_report
...
function _distance_matrix(
    treated::AbstractDataFrame,
    control::AbstractDataFrame;
    metric::Symbol = :haversine,
)
